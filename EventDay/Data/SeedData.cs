...
namespace EventDay.Data
{
    ...
    {
        internal static async Task InitialzeAcync(IServiceProvider services)
        {
            using var db = new EventDayContext
                (services.GetRequiredService<DbContextOptions<EventDayContext>>());
